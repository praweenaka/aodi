...
<section class="hero hero-slider-wrapper hero-slider-style-2">
    <div class="hero-slider">
        <div class="slide">
            <img src="img/x1.png" alt class="slider-bg">
            <div class="container">
                <div class="row">
        ...
        <div class="row">
            ...
            <div class="col col-md-4">
                <div class="all-service-link">
                    <a href="#" class="theme-btn">All services</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane in active" id="tab-1">
                                ...
                                <div class="details">
                                    ...
                                    <a href="#" class="more">View Details <i class="fa fa-angle-right"></i></a>
                                </div>
                            </div> 
                        </div>
                    </div>  
            ...
            <div class="recent-projects-grids">
                <div class="grid">
                    <div class="project-img">
                        <img src="assets/images/projects/x1.png" alt>
                    </div>
...
<!-- <section class="cta-newsletter parallax" data-bg-image="assets/images/contact-section-bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col col-xs-12">
                ...
                <div class="newsletter-pic">
                    <img src="assets/images/newsletter-pic.png" alt>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-md-4 col-md-offset-1 col-md-5">
                <div class="contact-section-contact-box">
                    ...
                    <div class="details">
                        ...
                        <ul>
                            <li><i class="fa fa-phone"></i> +94 777008982 / +94 771343595</li>
                            <li><i class="fa fa-envelope"></i> kelum.aodi@outlook.com</li>
            ...
            <div class="col col-lg-6 col-lg-offset-1 col-md-7">
                <div class="section-title-white" >
                 <a name="requestquo"> <h2>Request a quote</h2></a>
             </div>   
