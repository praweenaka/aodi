...
<head>
    ...
    <!-- Page Title -->
    <title>AODI INTERNATIONAL LANKA PVT LTD</title>
        ...
        <header id="header" class="site-header header-style-5">
                            ...
                            <div class="topbar-contact-info-wrapper">
                                <div class="topbar-contact-info">
                                    <div>
                                        ...
                                        <div class="details">
                                            <p>263,Temple Road, Biyagama.</p>
                                        </div>
                                    </div>
                                    <div>
                                        <i class="fa fa-phone"></i>
                                        <div class="details">
                                            <p>+94 777008982/ +94 771343595</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container">
                    ...
                    <a href="#requestquo" class="theme-btn-s2 request-quote">Request Quote</a>
